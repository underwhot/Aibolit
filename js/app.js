(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__slider")) new core(".hero__slider", {
            modules: [ Pagination, Autoplay, Parallax, Lazy ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 0,
        ...
        if (document.querySelector(".bot-specialist__slider")) new core(".bot-specialist__slider", {
            ...
            navigation: {
                prevEl: ".bot-specialist-prev",
                nextEl: ".bot-specialist-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.3
